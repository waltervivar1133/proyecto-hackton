...
export const Step4 = () => {
  return (
    <div className="h-screen grid justify-items-center  bg-4">
        <div className="mt-5">
            <img src="https://www.ebankingnews.com/wp-content/uploads/2011/03/credito1.gif" width="150px" height="100px" alt=""/>
        </div>
        <div>
          <h1 className="text-lg font-sans	 text-white p-3 text-center">Si deseas donar revisa las recomendaciones</h1>
        </div>
        <div>
